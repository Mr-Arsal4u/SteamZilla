...
@section('title', 'Create Time Slot - SteamZilla')
@section('page-title', 'Create Time Slot')

@section('content')
<div class="mb-4 sm:mb-6">
    <a href="{{ route('admin.time-slots') }}" class="text-[#45A247] hover:text-[#3a8a3c] text-sm sm:text-base">
        <i class="fas fa-arrow-left mr-2"></i>Back to Time Slots
    </a>
</div>

<div class="bg-white rounded-lg shadow p-4 sm:p-6 max-w-3xl mx-auto">
    <h2 class="text-xl sm:text-2xl font-bold text-gray-900 mb-4 sm:mb-6">Create New Time Slot</h2>
    ...
    <form action="{{ route('admin.time-slots.store') }}" method="POST">
        ...
        <div class="space-y-6">
            ...
            <div class="flex flex-col sm:flex-row justify-end space-y-2 sm:space-y-0 sm:space-x-4">
                <a href="{{ route('admin.time-slots') }}" class="bg-gray-200 text-gray-700 px-4 sm:px-6 py-2 rounded-lg font-semibold hover:bg-gray-300 transition text-center text-sm sm:text-base">
                    Cancel
                </a>
