...
@section('title', 'Edit Blog Post - SteamZilla')
...
<div class="bg-white rounded-lg shadow p-4 sm:p-6 max-w-4xl mx-auto">
    <h2 class="text-xl sm:text-2xl font-bold text-gray-900 mb-4 sm:mb-6">Edit Blog Post</h2>
        ...
        <div class="space-y-6">
            ...
            <div>
                ...
                <textarea name="excerpt" id="excerpt" rows="3"
                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#45A247] focus:border-[#45A247]" placeholder="Short summary shown in listings">{{ old('excerpt', $post->excerpt) }}</textarea>
            </div>
            
            <div>
                <label for="content" class="block text-sm font-medium text-gray-700 mb-2">Content</label>
                <textarea name="content" id="content" rows="10"
                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#45A247] focus:border-[#45A247]">{{ old('content', $post->content) }}</textarea>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    @if($post->featured_image)
                        <div class="mb-2">
                            <img src="{{ Storage::url($post->featured_image) }}" alt="Featured" class="h-20 w-auto rounded border border-gray-300">
                        </div>
                    @endif
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div>
                    ...
                    <label class="inline-flex items-center space-x-2">
                        <input type="checkbox" name="is_published" value="1" class="rounded border-gray-300 text-[#45A247]" {{ old('is_published', $post->is_published) ? 'checked' : '' }}>
                ...
                <div>
                    ...
                    <label class="inline-flex items-center space-x-2">
                        <input type="checkbox" name="is_featured" value="1" class="rounded border-gray-300 text-[#45A247]" {{ old('is_featured', $post->is_featured) ? 'checked' : '' }}>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea name="meta_description" id="meta_description" rows="3"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#45A247] focus:border-[#45A247]">{{ old('meta_description', $post->meta_description) }}</textarea>
                    </div>
                    <div>
