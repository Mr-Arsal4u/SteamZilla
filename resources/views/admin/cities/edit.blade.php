...
@section('title', 'Edit City - SteamZilla')
...
<div class="bg-white rounded-lg shadow p-6 max-w-3xl">
    <h2 class="text-2xl font-bold text-gray-900 mb-6">Edit City</h2>
        ...
        <div class="space-y-6">
            ...
            <div>
                <label class="flex items-center cursor-pointer">
                    <input type="checkbox" name="is_active" value="1" {{ old('is_active', $city->is_active) ? 'checked' : '' }} class="mr-2">
