...
@section('title', 'Create Add-On - SteamZilla')
...
<div class="bg-white rounded-lg shadow p-4 sm:p-6 max-w-3xl mx-auto">
    <h2 class="text-xl sm:text-2xl font-bold text-gray-900 mb-4 sm:mb-6">Create New Add-On</h2>
    ...
    <form action="{{ route('admin.addons.store') }}" method="POST">
        ...
        <div class="space-y-6">
            ...
            <div>
                ...
                <input type="text" name="category" id="category" value="{{ old('category') }}" placeholder="e.g., Interior, Exterior, Protection"
                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#45A247] focus:border-[#45A247]">
            </div>
            
            <div>
                <label class="flex items-center cursor-pointer">
                    <input type="checkbox" name="has_quantity" value="1" {{ old('has_quantity') ? 'checked' : '' }} class="mr-2">
