...
@section('title', 'Edit Blog Category - SteamZilla')
...
<div class="bg-white rounded-lg shadow p-4 sm:p-6 max-w-3xl mx-auto">
    <h2 class="text-xl sm:text-2xl font-bold text-gray-900 mb-4 sm:mb-6">Edit Category</h2>
        ...
        <div class="space-y-6">
            ...
            <div>
                ...
                <textarea name="description" id="description" rows="4"
                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#45A247] focus:border-[#45A247]">{{ old('description', $category->description) }}</textarea>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <label class="inline-flex items-center space-x-2">
                        <input type="checkbox" name="is_active" class="rounded border-gray-300 text-[#45A247]" {{ old('is_active', $category->is_active) ? 'checked' : '' }}>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea name="meta_description" id="meta_description" rows="3"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#45A247] focus:border-[#45A247]">{{ old('meta_description', $category->meta_description) }}</textarea>
                    </div>
                    <div>
