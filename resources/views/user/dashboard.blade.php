...
<!-- Welcome Section -->
<div class="bg-gradient-to-r from-[#45A247] to-[#3a8a3c] rounded-lg shadow-lg p-6 mb-8 text-white">
    <div class="flex items-center justify-between">
        <div>
            <h2 class="text-2xl font-bold mb-2">Welcome back, {{ $user->name }}!</h2>
            <p class="text-gray-100">Here's an overview of your account activity</p>
        </div>
        @if($user->avatar)
            <img src="{{ Storage::url($user->avatar) }}" alt="{{ $user->name }}" class="w-20 h-20 rounded-full border-4 border-white shadow-lg">
        @else
            <div class="w-20 h-20 rounded-full bg-white/20 flex items-center justify-center border-4 border-white">
    ...
    <div class="bg-white rounded-lg shadow p-6 border-l-4 border-green-500">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-3xl font-bold text-gray-900 mt-2">{{ $stats['completed_bookings'] }}</p>
            </div>
        ...
        <div class="divide-y divide-gray-200">
            ...
            <div class="p-6 hover:bg-gray-50 transition">
                <div class="flex items-start justify-between">
                    <div class="flex-1">
                        <h4 class="font-semibold text-gray-900 mb-1">{{ $booking->package->name }}</h4>
    ...
    <div class="bg-white rounded-lg shadow">
        ...
        <div class="divide-y divide-gray-200">
            ...
            <div class="p-6 hover:bg-gray-50 transition">
                <div class="flex items-start justify-between">
                    <div class="flex-1">
                        <p class="text-sm text-gray-600 mb-2 line-clamp-2">{{ Str::limit($submission->message, 100) }}</p>
...
<div class="mt-8 bg-white rounded-lg shadow p-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        <a href="{{ route('order-now') }}" class="flex items-center p-4 bg-[#45A247]/10 rounded-lg hover:bg-[#45A247]/20 transition">
            <div class="w-12 h-12 bg-[#45A247] rounded-full flex items-center justify-center mr-4">
                <i class="fas fa-plus text-white text-xl"></i>
            </div>
            <div>
                <h4 class="font-semibold text-gray-900">Book Service</h4>
                <p class="text-sm text-gray-600">Schedule a new cleaning</p>
            </div>
        </a>
        <a href="{{ route('user.contact') }}" class="flex items-center p-4 bg-blue-50 rounded-lg hover:bg-blue-100 transition">
        ...
        <a href="{{ route('user.profile') }}" class="flex items-center p-4 bg-purple-50 rounded-lg hover:bg-purple-100 transition">
            <div class="w-12 h-12 bg-purple-500 rounded-full flex items-center justify-center mr-4">
                <i class="fas fa-user text-white text-xl"></i>
            </div>
            <div>
                <h4 class="font-semibold text-gray-900">Update Profile</h4>
