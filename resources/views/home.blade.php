...
<section class="relative h-[700px] md:h-[800px] flex items-center overflow-hidden">
    ...
    <div class="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div class="max-w-3xl bg-black/30 backdrop-blur-sm rounded-2xl p-8 md:p-12">
            <h1 class="text-4xl md:text-6xl lg:text-7xl font-black text-white mb-6 leading-tight animate-fade-in drop-shadow-2xl">
                {{ $heroTitle }}
            </h1>
            @if($heroSubtitle)
            <p class="text-xl md:text-2xl text-white mb-6 font-semibold drop-shadow-lg">
                {{ $heroSubtitle }}
            </p>
            @endif
            @if($heroDescription)
            <p class="text-base md:text-lg text-white mb-8 leading-relaxed drop-shadow-md">
                {{ $heroDescription }}
            </p>
            @endif
...
<section class="py-20 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        @if($benefitsTitle)
            <h2 class="text-3xl md:text-4xl font-bold text-center mb-4 text-gray-900">{{ $benefitsTitle }}</h2>
        @endif
        @if($benefitsDescription)
            <p class="text-center text-gray-600 mb-12 text-lg max-w-3xl mx-auto">{{ $benefitsDescription }}</p>
        @endif
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div class="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border-2 border-gray-100">
                ...
                <h3 class="text-2xl font-bold text-gray-900 mb-4">Convenience That Dominates</h3>
                <p class="text-gray-600 leading-relaxed">We come to you. Your home, your office, your life. Schedule online and watch the beast get to work.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="py-20 bg-[#F7FFF7]">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        @if($howItWorksTitle)
            <h2 class="text-3xl md:text-4xl font-bold text-center mb-4 text-gray-900">{{ $howItWorksTitle }}</h2>
        @endif
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div class="text-center">
                ...
                <div class="w-12 h-1 bg-[#45A247] mx-auto mb-6 hidden lg:block"></div>
            ...
            <div class="text-center">
                ...
                <h3 class="text-xl font-bold mb-3 text-gray-900">Enjoy Your Fresh Car</h3>
                <p class="text-gray-600">Your car feels fresh, sanitized, and spotless.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="relative py-24 overflow-hidden">
    ...
    <div class="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
                <h2 class="text-4xl md:text-5xl font-bold text-white mb-8">Why Choose Steam Zila</h2>
                <ul class="space-y-4">
                    <li class="flex items-start">
                        <i class="fas fa-check-circle text-[#45A247] text-2xl mr-4 mt-1"></i>
                        <span class="text-white text-lg">Water-saving steam technology</span>
                    </li>
                    <li class="flex items-start">
                        <i class="fas fa-check-circle text-[#45A247] text-2xl mr-4 mt-1"></i>
                        <span class="text-white text-lg">Gentle on paint & interior</span>
                    </li>
                    <li class="flex items-start">
                        <i class="fas fa-check-circle text-[#45A247] text-2xl mr-4 mt-1"></i>
                        <span class="text-white text-lg">Removes stains & odors</span>
                    </li>
                    <li class="flex items-start">
                        <i class="fas fa-check-circle text-[#45A247] text-2xl mr-4 mt-1"></i>
